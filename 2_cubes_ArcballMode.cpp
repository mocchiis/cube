...
// シェーダファイル
static std::string VERT_SHADER_FILE = std::string(SHADER_DIRECTORY2) + "render3.vert";
static std::string FRAG_SHADER_FILE = std::string(SHADER_DIRECTORY2) + "render3.frag";
